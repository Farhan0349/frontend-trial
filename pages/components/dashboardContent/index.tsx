...
import { Image as ChakraImage, Box, Button, FormControl, FormErrorMessage, FormLabel, Grid, GridItem, Input, Menu, MenuButton, MenuItem, MenuList, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Tab, Table, TableCaption, TableContainer, TabList, TabPanel, TabPanels, Tabs, Tbody, Td, Text, Textarea, Tfoot, Th, Thead, Tr, useDisclosure, Flex, InputGroup } from "@chakra-ui/react"
...
const DashboardContent = () => {
    ...
    return (
        <Box w="100%">
            <Tabs w="100%">
                <TabList w="100%">
                    <Tab w="100%"><Button>Dashboard</Button></Tab>
                    <Tab w="100%"><Button onClick={onAnimalOpen}>Add Animals</Button></Tab>
                    <Tab w="100%"><Button onClick={onShedOpen}>Add Sheds</Button></Tab>
                </TabList>
